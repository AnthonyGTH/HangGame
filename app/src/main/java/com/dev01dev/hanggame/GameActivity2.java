...
public class GameActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        random = new Random();
        mediaPlayer = MediaPlayer.create(this, R.raw.ouch1);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.ouch2);
        mediaPlayer3 = MediaPlayer.create(this, R.raw.yay);

        parts = new ImageView[sizeParts];
        parts[0]=findViewById(R.id.body);
        parts[1]=findViewById(R.id.arms);
        parts[2]=findViewById(R.id.legs);
        playGame();
    }
    ...
    public void letterPressed(View view){
        ...
        if(correct) {
            if (numCorr == numChars) {
                ...
                builder.setMessage("Felicidades has adivinado la palabra y has salvado a Tom");
                builder.setPositiveButton("Intentar ota vez", new DialogInterface.OnClickListener() {
                    @Override
            ...
            builder.setMessage("No has podido salvar a Tom\nLa palabra era: "+currWord);
            builder.setPositiveButton("Intentar ota vez", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    GameActivity2.this.playGame();
